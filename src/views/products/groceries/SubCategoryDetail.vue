        ...
        <v-container>
            ...
            <v-row justify="center">
                ...
                <v-col cols="12">
                    <v-row justify="center">
                        <v-img
                            :src="subcategory.image ? subcategory.image : `https://images.pexels.com/photos/1279330/pexels-photo-1279330.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940`"
            ...
            <v-row justify="center">
                <v-col cols="12">
                    ...
                    >
                        <v-row wrap>
                            <v-col cols="6" md="2" lg="2" v-for="(item, index) in items" :key="index">
...
export default {
    ...
    created() {
        axios({
            url: `${this.$store.state.apiUrl}grocery/sub-categories/${this.$route.params.subCategoryId}/`,
            method: "GET",
        })
            .then((response) => {
    ...
    mounted() {
        axios({
            url: `${this.$store.state.apiUrl}grocery/items/?active=true&sub_category=${this.$route.params.subCategoryId}`,
            method: "GET",
        })
            .then((response) => {
