...
export default {
  ...
  created() {
    axios({
      url: `${process.env.VUE_APP_API_URL}grocery/categories/${this.$route.params.categoryId}/`,
      method: "GET",
    })
      .then((response) => {
  ...
  mounted() {
    axios({
      url: `${process.env.VUE_APP_API_URL}grocery/sub-categories/?active=true&category=${this.$route.params.categoryId}`,
      method: "GET",
    })
      .then((response) => {
