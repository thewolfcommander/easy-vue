...
export default {
  ...
  created() {
    axios({
      url: `${process.env.apiUrl}grocery/categories/${this.$route.params.categoryId}/`,
      method: "GET",
    })
      .then((response) => {
  ...
  mounted() {
    axios({
      url: `${process.env.apiUrl}grocery/sub-categories/?active=true&category=${this.$route.params.categoryId}`,
      method: "GET",
    })
      .then((response) => {
