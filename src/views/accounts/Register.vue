  ...
  <v-container fluid>
    <v-container>
        ...
        <v-col cols="12" md="7" lg="6">
          <v-card flat max-width="600px">
            <v-row wrap justify="center">
              ...
              <v-col cols="12" md="8" class="mt-n5">
                <v-row justify="center">
                  <v-btn large @click="sendOTP" color="primary" rounded
                    >Register</v-btn
                  >
                </v-row>
              </v-col>
      ...
      <v-row v-else justify="center">
        ...
        <v-btn rounded color="primary" router :to="{ name: 'Profile' }"
          >Go to Profile</v-btn
        >
      </v-row>
      <v-bottom-sheet v-model="sendOtpSheetOpen" persistent>
        <v-sheet height="210px">
          <v-btn
            style="color : black"
            text
            class="mt-1"
  ...
  data() {
    return {
      ...
      rules: {
        ...
        counter: (value) => value.length <= 10 || "Exactly 10 characters",
        username: (value) => {
          const pattern = /^\d{10}$/;
