<template>
  <v-expansion-panel>
    ...
    <v-expansion-panel-content>
      <v-list-item two-line v-for="pro in pros" :key="pro.key">
        <v-list-item-content>
                  ...
                  <v-card class="pa-2">
                    <v-list-item>
                      ...
                      <v-list-item-content>
                        ...
                        <v-list-item-subtitle>
                          <router-link
                            :to="{
                              ...
                              params: { restaurantId: item.food.restaurant.id },
                            }"
                        ...
                        <v-list-subtitle
                          >&#8377;
                          <strike class="grey--text caption">{{
                            item.food.gross_price
                          }}</strike>
                        ...
                        >
                        <v-chip-group>
                          <v-chip color="primary" :key="item.varientType">
